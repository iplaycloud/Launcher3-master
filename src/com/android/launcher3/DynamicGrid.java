...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources, int minWidthPx, int minHeightPx, int widthPx,
        ...
        deviceProfiles.add(new DeviceProfile("Short Stubby", 275, 420, 4, 4, ICON_SIZE_DP_SMALL, 13, 3,
                ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_4x4_no_all_apps));
        */
        /*                                 任意定义     最小宽度 最小高度 行数    列数    Icon的size Icon的文字size    Hotseat的Icon个数、Hotseat的Icon的size */
        //deviceProfiles.add(new DeviceProfile("Stubby",  255,    450,    5,     4,    ICON_SIZE_DP_SMALL, 13,        (hasAA ? 5 : 4),    ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_5x4_no_all_apps));

        /// M: add 294 X 460 profile
        /*
        deviceProfiles.add(new DeviceProfile("294 X 460", 294, 460,  4, 4,  50.34943f, 13, (hasAA ? 5 : 4), 49.566288f, R.xml.default_workspace,
        ...
        */
        deviceProfiles.add(new DeviceProfile("Nexus 5", 359, 567, 3, 6, DEFAULT_ICON_SIZE_DP, 15, (hasAA ? 5 : 6),
                DEFAULT_ICON_SIZE_DP, R.xml.default_workspace, R.xml.default_workspace_3x6_no_all_apps));
        ...
        */
        ...
        deviceProfiles.add(new DeviceProfile("Large Phone", 406, 694, 4, 4, ICON_SIZE_DP_BIGGER, 14.4f, 4,
                ICON_SIZE_DP_BIGGER, R.xml.default_workspace, R.xml.default_workspace_4x4_no_all_apps));
